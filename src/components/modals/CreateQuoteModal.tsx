...
interface CreateQuoteModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (quote: { content: string; author: string }) => Promise<void>;
}

export default function CreateQuoteModal({ isOpen, onClose, onSubmit }: CreateQuoteModalProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6">Create a New Quote</h2>
